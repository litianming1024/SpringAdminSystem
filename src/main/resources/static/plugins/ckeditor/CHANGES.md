...
* [#11387](http://dev.ckeditor.com/ticket/11387): Fixed: `group="radiogroup"` should be applied only to radio inputs' container.
...
* [#10360](http://dev.ckeditor.com/ticket/10360): Fixed: ARIA `group="application"` should not be used for dialog windows.
* [#10361](http://dev.ckeditor.com/ticket/10361): Fixed: ARIA `group="application"` should not be used for floating panels.
